...
## Overview
This is a generated example of a skill detail page for **Skill Component 3**.
...
```javascript
import { SkillComponent3 } from '@cool-tools/utils';

const instance = new SkillComponent3();
instance.run();
```
