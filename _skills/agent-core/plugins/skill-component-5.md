...
## Overview
This is a generated example of a skill detail page for **Skill Component 5**.
...
```javascript
import { SkillComponent5 } from '@agent-core/plugins';

const instance = new SkillComponent5();
instance.run();
```
