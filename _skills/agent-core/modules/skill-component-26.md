...
## Overview
This is a generated example of a skill detail page for **Skill Component 26**.
...
```javascript
import { SkillComponent26 } from '@agent-core/modules';

const instance = new SkillComponent26();
instance.run();
```
