...
## Overview
This is a generated example of a skill detail page for **Skill Component 20**.
...
```javascript
import { SkillComponent20 } from '@ai-forge/plugins';

const instance = new SkillComponent20();
instance.run();
```
