...
## Overview
This is a generated example of a skill detail page for **Skill Component 22**.
...
```javascript
import { SkillComponent22 } from '@open-source-heroes/extensions';

const instance = new SkillComponent22();
instance.run();
```
