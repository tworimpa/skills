...
## Overview
This is a generated example of a skill detail page for **Skill Component 6**.
...
```javascript
import { SkillComponent6 } from '@open-source-heroes/extensions';

const instance = new SkillComponent6();
instance.run();
```
